...
public class FeedbackController {
    ...
    public String submitFeedback(String value, String rate) {
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();

        if (authentication.getPrincipal() instanceof Employee) {
            Employee user = (Employee) authentication.getPrincipal();
            Long idEmploye = user.getId(); // Supposons que votre classe Employee a une méthode pour obtenir l'ID de l'employé.
